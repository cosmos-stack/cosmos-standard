...
namespace CosmosStandardUT.TypeUT
{
    ...
    public class TypeOfTests
    {
        ...
        public void MultiValueTypeViaGenericTest()
        {
        ...
        [Fact(DisplayName = "Multi GenericType with TypeOfOptions.Underlying test")]
        public void MultiValueTypeViaGenericWithOfOptionsTest()
        {
