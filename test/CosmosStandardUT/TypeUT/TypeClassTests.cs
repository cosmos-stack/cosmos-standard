...
namespace CosmosStandardUT.TypeUT
{
    ...
    {
        [Fact(DisplayName = "Void test")]
        public void VoidTypeTest()
        {
            TypeClass.VoidClazz.ShouldBe(typeof(void));
        }

        [Fact(DisplayName = "DirectType test")]
        public void DirectTypeTest()
        {
        ...
        [Fact(DisplayName = "DirectType array test")]
        public void DirectTypeArrayTest()
        {
            TypeClass.ObjectArrayClazz.ShouldBe(typeof(object[]));
            TypeClass.ByteArrayClazz.ShouldBe(typeof(byte[]));
            
            TypeClass.ListClazz.ShouldBe(typeof(List<>));
            TypeClass.GenericListClazz.ShouldBe(typeof(List<>));
        }

        [Fact(DisplayName = "NullableType test")]
        ...
        [Fact(DisplayName = "Interface test")]
