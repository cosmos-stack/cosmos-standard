...
namespace CosmosStandardUT.ConvUT
{
    ...
    public class StringConvBeDoubleTypeTests
    {
        ...
        public void JudgingStringIsDoubleTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.Is<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.Is<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text2.Is<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text3.Is<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text4.Is<Double>(IgnoreCase.TRUE).ShouldBeTrue();
        }
        ...
        public void JudgingNullOrEmptyStringIsDoubleTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.Is<Double>(IgnoreCase.TRUE).ShouldBeFalse();
            text1.Is<Double>(IgnoreCase.TRUE).ShouldBeFalse();
            text2.Is<Double>(IgnoreCase.TRUE).ShouldBeFalse();
            text3.Is<Double>(IgnoreCase.TRUE).ShouldBeFalse();
        }
        ...
        public void JudgingStringIsNullableDoubleTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text2.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text3.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text4.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
        ...
        public void JudgingNullOrEmptyStringIsNullableDoubleTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeFalse();
            text2.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeFalse();
            text3.IsNullable<Double>(IgnoreCase.TRUE).ShouldBeFalse();
