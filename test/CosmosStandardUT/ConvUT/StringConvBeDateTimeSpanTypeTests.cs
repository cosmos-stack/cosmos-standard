...
namespace CosmosStandardUT.ConvUT
{
    ...
    public class StringConvBeDateTimeSpanTypeTests
    {
        ...
        public void JudgingStringIsDateTimeSpanTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
            text2.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
        }
        ...
        public void JudgingNullOrEmptyStringIsDateTimeSpanTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
            text1.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
            text2.Is<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
        }
        ...
        public void JudgingStringIsNullableDateTimeSpanTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
            text2.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
        ...
        public void JudgingNullOrEmptyStringIsNullableDateTimeSpanTypeByGenericTypeAndWithIgnoreCaseTest()
        {
            ...
            text0.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeTrue();
            text1.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
            text2.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
        ...
        public void JudgingInvalidStringToNullableDateTimeSpanTypeTest()
        {
            ...
            text0.IsNullable<DateTimeSpan>(IgnoreCase.TRUE).ShouldBeFalse();
