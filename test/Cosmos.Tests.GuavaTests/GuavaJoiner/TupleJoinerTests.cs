...
namespace Cosmos.Tests.GuavaTests.GuavaJoiner
{
    public class TupleJoinerTests
    {
        private static class OriginalMaterials
        {
            ...
            public static List<(string, string)> IncludeNullValueTupleList { get; } = new List<(string, string)> { ("a", "1"), ("b", "2"), ("c", "3"), ("d", "4"), (string.Empty, string.Empty) };
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeWhiteSpaceKvTupleList);
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeNullKvTupleList);
            str.ShouldBe("a=1&b=2&c=3&d=4&e=NullValue");
        }
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeEmptyKvTupleList);
            str.ShouldBe("a=1&b=2&c=3&d=4&e=NullValue");
        }
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeWhiteSpaceValueTupleList);
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeNullValueTupleList);
            str.ShouldBe("a=1&b=2&c=3&d=4&NullKey=NullValue");
        }
        ...
        {
            var str = Joiner.On("&").WithKeyValueSeparator("=").FromTuple().UseForNull<string, string>((t1, t2) => "NullKey", (t1, t2) => "NullValue").Join(OriginalMaterials.IncludeEmptyValueTupleList);
            str.ShouldBe("a=1&b=2&c=3&d=4&NullKey=NullValue");
        }
    }
}
