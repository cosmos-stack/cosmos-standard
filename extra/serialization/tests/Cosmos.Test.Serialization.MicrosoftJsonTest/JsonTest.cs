...
namespace Cosmos.Test.Serialization.MicrosoftJsonTest
{
    public class JsonTest
    {
        ...
        public void BasicJsonTest()
        {
            ...
            var back2 = (NiceModel) json1.FromMicrosoftJson(typeof(NiceModel));
        ...
        public void OptionalJsonTest()
        {
            ...
            var json1 = model.ToMicrosoftJson(options);
            var back1 = json1.FromMicrosoftJson<NiceModel>(options);
            var back2 = (NiceModel) json1.FromMicrosoftJson(typeof(NiceModel), options);
