...
namespace Cosmos.Test.Serializaion.KoobooTest
{
    public class UnitTestAsync
    {
        ...
        {
            var model = CreateNiceModel();
            var stream1 = await model.KoobooPackAsync();
            var stream2 = new MemoryStream();
            await model.KoobooPackToAsync(stream2);
            var stream3 = new MemoryStream();
            await stream3.KoobooPackByAsync(model);

            var back1 = await stream1.KoobooUnpackAsync<NiceModel>();
            var back2 = await stream2.KoobooUnpackAsync<NiceModel>();
            var back3 = await stream3.KoobooUnpackAsync<NiceModel>();
        ...
        public async Task NonGenericStreamTest()
        {
            ...
            var back1 = (NiceModel) await stream1.KoobooUnpackAsync(typeof(NiceModel));
            var back2 = (NiceModel) await stream2.KoobooUnpackAsync(typeof(NiceModel));
            var back3 = (NiceModel) await stream3.KoobooUnpackAsync(typeof(NiceModel));
