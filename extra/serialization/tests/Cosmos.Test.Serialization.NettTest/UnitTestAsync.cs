...
using Cosmos.Serialization.Toml;
using Xunit;
...
namespace Cosmos.Test.Serialization.NettTest {
    public class UnitTestAsync {
        ...
        public async Task StreamTest() {
            var model = CreateNiceModel();
            var stream1 = await model.TomlPackAsync();
            var stream2 = new MemoryStream();
            await model.TomlPackToAsync(stream2);
            var stream3 = new MemoryStream();
            await stream3.TomlPackByAsync(model);

            var back1 = await stream1.TomlUnpackAsync<NiceModel>();
            var back2 = await stream2.TomlUnpackAsync<NiceModel>();
            var back3 = await stream3.TomlUnpackAsync<NiceModel>();
        ...
        public async Task NonGenericStreamTest() {
            ...
            var back1 = (NiceModel) await stream1.TomlUnpackAsync(typeof(NiceModel));
            var back2 = (NiceModel) await stream2.TomlUnpackAsync(typeof(NiceModel));
            var back3 = (NiceModel) await stream3.TomlUnpackAsync(typeof(NiceModel));
