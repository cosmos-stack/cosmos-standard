...
namespace Cosmos.Test.Serialization.NettTest {
    public class UnitTest {
        ...
        public void StreamTest() {
            var model = CreateNiceModel();
            var stream1 = model.TomlPack();
            var stream2 = new MemoryStream();
            model.TomlPackTo(stream2);
            var stream3 = new MemoryStream();
            stream3.TomlPackBy(model);

            var back1 = stream1.TomlUnpack<NiceModel>();
            var back2 = stream2.TomlUnpack<NiceModel>();
            var back3 = stream3.TomlUnpack<NiceModel>();
        ...
        public void NonGenericStreamTest() {
            ...
            var back1 = (NiceModel) stream1.TomlUnpack(typeof(NiceModel));
            var back2 = (NiceModel) stream2.TomlUnpack(typeof(NiceModel));
            var back3 = (NiceModel) stream3.TomlUnpack(typeof(NiceModel));
