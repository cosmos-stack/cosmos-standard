...
namespace Cosmos.Test.Serialization.JilTest
{
    public class JsonTestAsync
    {
        ...
        public async Task BasicJsonTest()
        {
            ...
            var back2 = (NiceModel) await json1.FromJilAsync(typeof(NiceModel));
        ...
        public async Task OptionalJsonTest()
        {
            ...
            var json1 = await model.ToJilAsync(options);
            var back1 = await json1.FromJilAsync<NiceModel>(options);
            var back2 = (NiceModel) await json1.FromJilAsync(typeof(NiceModel), options);
