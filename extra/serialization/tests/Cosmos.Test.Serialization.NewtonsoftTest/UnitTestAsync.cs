...
namespace Cosmos.Test.Serialization.NewtonsoftTest
{
    public class UnitTestAsync
    {
        ...
        public async Task BytesTest()
        {
            ...
            var bytes = await model.ToJsonAsync();
            var backs = await bytes.FromJsonAsync<NiceModel>();
        ...
        public async Task NonGenericBytesTest()
        {
            var model = CreateNiceModel();
            var bytes = await model.ToJsonAsync();
            var backs = (NiceModel) await bytes.FromJsonAsync(typeof(NiceModel));
        ...
        {
            var model = CreateNiceModel();
            var stream1 = await model.JsonPackAsync();
            var stream2 = new MemoryStream();
            await model.JsonPackToAsync(stream2);
            var stream3 = new MemoryStream();
            await stream3.JsonPackByAsync(model);

            var back1 = await stream1.JsonUnpackAsync<NiceModel>();
            var back2 = await stream2.JsonUnpackAsync<NiceModel>();
            var back3 = await stream3.JsonUnpackAsync<NiceModel>();
        ...
        public async Task NonGenericStreamTest()
        {
            ...
            var back1 = (NiceModel) await stream1.JsonUnpackAsync(typeof(NiceModel));
            var back2 = (NiceModel) await stream2.JsonUnpackAsync(typeof(NiceModel));
            var back3 = (NiceModel) await stream3.JsonUnpackAsync(typeof(NiceModel));
        ...
        public async Task NonGenericStringTest()
        {
            var model = CreateNiceModel();
            var json1 = await model.ToJsonAsync();
            var back1 = (NiceModel) await json1.FromJsonAsync(typeof(NiceModel));
