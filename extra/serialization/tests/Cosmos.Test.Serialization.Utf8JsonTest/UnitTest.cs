...
namespace Cosmos.Test.Serialization.Utf8JsonTest {
    public class UnitTest {
        ...
        public void StreamTest() {
            ...
            var back1 = stream1.Utf8JsonUnpack<NiceModel>();
            var back2 = stream2.Utf8JsonUnpack<NiceModel>();
            var back3 = stream3.Utf8JsonUnpack<NiceModel>();
        ...
        public void NonGenericStreamTest() {
            ...
            var back1 = (NiceModel) stream1.Utf8JsonUnpack(typeof(NiceModel));
            var back2 = (NiceModel) stream2.Utf8JsonUnpack(typeof(NiceModel));
            var back3 = (NiceModel) stream3.Utf8JsonUnpack(typeof(NiceModel));
