...
namespace Cosmos.Test.Serialization.ZeroFormatterTest {
    public class UnitTestAsync {
        ...
        public async Task BytesTest() {
            ...
            var bytes = await model.ToZeroFormatterAsync();
            var backs = await bytes.FromZeroFormatterAsync<NiceModel>();
        ...
        public async Task NonGenericBytesTest() {
            var model = CreateNiceModel();
            var bytes = await model.ToZeroFormatterAsync();
            var backs = (NiceModel) await bytes.FromZeroFormatterAsync(typeof(NiceModel));
