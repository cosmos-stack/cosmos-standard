...
namespace System.Linq
{
    public static partial class Extensions
    {
        ...
        /// <returns></returns>
        public static Task<TSource> Aggregate<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TSource, TSource> func,
        ...
        /// <returns></returns>
        public static Task<TAccumulate> Aggregate<TSource, TAccumulate>(this Task<AsyncWhereEnumerable<TSource>> source, TAccumulate seed,
        ...
        /// <returns></returns>
        public static Task<TResult> Aggregate<TSource, TAccumulate, TResult>(this Task<AsyncWhereEnumerable<TSource>> source, TAccumulate seed,
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<double?> Average<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, long?> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Average, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<float?> Average<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, float?> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Average, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<double> Average<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, double> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Average, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<decimal> Average<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, decimal> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Average, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<bool> Contains<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, TSource value, IEqualityComparer<TSource> comparer,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<TSource> FirstOrDefault<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<TSource> LastOrDefault<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<decimal?> Max<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, decimal?> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Max, cancellationToken);
        }
        ...
        /// <typeparam name="TResult"></typeparam>
        /// <returns></returns>
        public static Task<TResult> Max<TSource, TResult>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TResult> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Max, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<decimal?> Min<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, decimal?> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Min, cancellationToken);
        }
        ...
        /// <typeparam name="TResult"></typeparam>
        /// <returns></returns>
        public static Task<TResult> Min<TSource, TResult>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TResult> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Min, cancellationToken);
        }
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<bool> SequenceEqual<TSource>(this Task<AsyncWhereEnumerable<TSource>> first, IEnumerable<TSource> second,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<bool> SequenceEqual<TSource>(this Task<AsyncWhereEnumerable<TSource>> first, IEnumerable<TSource> second, IEqualityComparer<TSource> comparer,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<TSource> SingleOrDefault<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, bool> predicate,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TSource"></typeparam>
        /// <returns></returns>
        public static Task<decimal?> Sum<TSource>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, decimal?> selector,
            CancellationToken cancellationToken = default)
        {
            return Task.Factory.FromTaskEnumerable(source, selector, Enumerable.Sum, cancellationToken);
        }
        ...
        /// <returns></returns>
        public static Task<Dictionary<TKey, TSource>> ToDictionary<TSource, TKey>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TKey> keySelector,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        public static Task<Dictionary<TKey, TElement>> ToDictionary<TSource, TKey, TElement>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TKey> keySelector,
        ...
        /// <typeparam name="TKey"></typeparam>
        /// <returns></returns>
        public static Task<ILookup<TKey, TSource>> ToLookup<TSource, TKey>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TKey> keySelector,
            CancellationToken cancellationToken = default)
        {
        ...
        /// <typeparam name="TElement"></typeparam>
        /// <returns></returns>
        public static Task<ILookup<TKey, TElement>> ToLookup<TSource, TKey, TElement>(this Task<AsyncWhereEnumerable<TSource>> source, Func<TSource, TKey> keySelector,
            Func<TSource, TElement> elementSelector, CancellationToken cancellationToken = default)
        {
