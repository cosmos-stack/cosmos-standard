...
namespace Cosmos.Collections
{
    ...
    public static class Enumerables
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static List<T> EmptyList<T>() => EnumerableFactory.OfList<T>();
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static List<T> Create<T>(params IEnumerable<T>[] listParams) => EnumerableFactory.OfList(listParams);
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static IReadOnlyList<T> CreateAsReadOnly<T>(params IEnumerable<T>[] listParams) => EnumerableFactory.ReadOnly.OfList(listParams);
