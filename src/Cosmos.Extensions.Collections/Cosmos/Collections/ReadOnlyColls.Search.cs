...
namespace Cosmos.Collections
{
    ...
    public static partial class ReadOnlyCollsExtensions
    {
        ...
        {
            return ReadOnlyColls.BinarySearch(source, value);
        }
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static int BinarySearch<TSource, TValue>(this IReadOnlyList<TSource> source, Func<TSource, TValue> map, TValue value)
        {
            return ReadOnlyColls.BinarySearch(source, map, value);
        }
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static int BinarySearch<T>(this IReadOnlyList<T> source, int index, int length, T value)
        {
            return ReadOnlyColls.BinarySearch(source, index, length, value);
        }
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static int BinarySearch<TSource, TValue>(this IReadOnlyList<TSource> source, int index, int length, Func<TSource, TValue> map, TValue value)
        {
            return ReadOnlyColls.BinarySearch(source, index, length, map, value);
        }
        ...
        {
            return ReadOnlyColls.BinarySearch(source, value, comparer);
        }
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static int BinarySearch<TSource, TValue>(this IReadOnlyList<TSource> source, Func<TSource, TValue> map, TValue value, IComparer<TValue> comparer)
        {
            return ReadOnlyColls.BinarySearch(source, map, value, comparer);
        }
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static int BinarySearch<T>(this IReadOnlyList<T> source, int index, int length, T value, IComparer<T> comparer)
        {
            return ReadOnlyColls.BinarySearch(source, index, length, value, comparer);
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        /// <exception cref="InvalidOperationException"></exception>
        public static int BinarySearch<TSource, TValue>(this IReadOnlyList<TSource> source, int index, int length,
            Func<TSource, TValue> map, TValue value, IComparer<TValue> comparer)
        {
            return ReadOnlyColls.BinarySearch(source, index, length, map, value, comparer);
        }
