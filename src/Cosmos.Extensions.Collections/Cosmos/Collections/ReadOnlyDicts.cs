...
namespace Cosmos.Collections
{
    ...
    public static class ReadOnlyDictsExtensions
    {
        #region Get or Default (readonly)
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static TValue GetValueOrDefault<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key, Func<TKey, TValue> valueCalculator)
        {
            return ReadOnlyDicts.GetValueOrDefault(dictionary, key, valueCalculator);
        }
        ...
        {
            return ReadOnlyDicts.GetValueOrDefault(dictionary, key, defaultValue);
        }
        ...
        {
            return ReadOnlyDicts.GetValueOrDefault(dictionary, key);
        }
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static TValue GetValueOrDefaultCascading<TKey, TValue>(this IEnumerable<IReadOnlyDictionary<TKey, TValue>> dictionaryColl, TKey key, TValue defaultValue)
        {
            return ReadOnlyDicts.GetValueOrDefaultCascading(dictionaryColl, key, defaultValue);
        }
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static TValue GetValueOrDefaultCascading<TKey, TValue>(this IEnumerable<IReadOnlyDictionary<TKey, TValue>> dictionaryColl, TKey key)
        {
            return ReadOnlyDicts.GetValueOrDefaultCascading(dictionaryColl, key, default);
        }
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static bool TryGetValueCascading<TKey, TValue>(this IEnumerable<IReadOnlyDictionary<TKey, TValue>> dictionaryColl, TKey key, out TValue value)
        {
            return ReadOnlyDicts.TryGetValueCascading(dictionaryColl, key, out value);
        }
