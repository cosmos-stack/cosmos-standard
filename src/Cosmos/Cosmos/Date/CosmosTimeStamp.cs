...
namespace Cosmos.Date
{
    ...
    public class CosmosTimeStamp
    {
        ...
        /// <summary>
        /// Create a new instance of <see cref="CosmosTimeStamp"/>
        /// </summary>
        public CosmosTimeStamp() : this(DateTime.Now) { }

        /// <summary>
        /// Create a new instance of <see cref="CosmosTimeStamp"/>
        /// </summary>
        /// <param name="timestamp"></param>
        public CosmosTimeStamp(long timestamp) : this(FromTimestampFunc(timestamp), timestamp) { }

        /// <summary>
        /// Create a new instance of <see cref="CosmosTimeStamp"/>
        /// </summary>
        /// <param name="dt"></param>
        public CosmosTimeStamp(DateTime dt) : this(dt, ToTimestampFunc(dt)) { }

        private CosmosTimeStamp(DateTime dt, long timestamp)
        {
