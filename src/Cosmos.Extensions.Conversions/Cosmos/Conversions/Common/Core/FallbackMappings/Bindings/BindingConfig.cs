...
namespace Cosmos.Conversions.Common.Core.FallbackMappings.Bindings;

internal class BindingConfig
{
    private readonly Dictionary<string, List<string>> _oneToOneBindFields = new();
    private readonly Dictionary<string, List<BindingFieldPath>> _bindFieldsPath = new();
    private readonly Dictionary<string, Type> _bindTypes = new();
    private readonly Dictionary<string, Func<object, object>> _customTypeConverters = new();
