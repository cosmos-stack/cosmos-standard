...
namespace CosmosStack.Date.Chinese
{
    /// <summary>
    ...
    public static class ChineseSolarTermHelper
    {
        ...
        // ReSharper disable once IdentifierTypo
        // ReSharper disable once InconsistentNaming
        private static readonly string[] SOLARTERME =
        {
        ...
        // ReSharper disable once IdentifierTypo
        // ReSharper disable once InconsistentNaming
        private static readonly List<ChineseSolarTerms> SOLARTERMENUM = new()
        {
        ...
        /// <summary>
        /// Convert <see cref="ChineseSolarTerms"/> to English name.<br />
        /// 将 <see cref="ChineseSolarTerms"/> 转换为英文名称。
        /// </summary>
        /// <param name="solarTerms"></param>
        /// <returns></returns>
