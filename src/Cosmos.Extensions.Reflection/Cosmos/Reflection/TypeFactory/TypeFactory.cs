...
internal static partial class TypeFactory
{
    ...
    private static readonly ModuleBuilder _moduleBuilder =
        AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("Cosmos.Reflection.NRefDynamic"), AssemblyBuilderAccess.Run)
                       .DefineDynamicModule("Cosmos.Reflection.NRefDynamic");
    ...
    public static Type CreateType(IDictionary<string, Type> properties)
    {
        ...
        var typeBuilder = _moduleBuilder.DefineType($"Cosmos.Reflection.NRefDynamic.Dynamic_{Guid.NewGuid().ToString("N").ToUpper()}",
