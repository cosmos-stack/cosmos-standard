...
namespace CosmosStack.Reflection
{
    ...
    public static partial class TypeReflections
    {
        ...
        {
            return X(member, type => type, type => CosmosStack.Reflection.Types.IsNumericType(type, isOptions));
        }
        ...
        {
            return X(member, type => type, type => CosmosStack.Reflection.Types.IsEnumType(type, isOptions));
        }
        ...
        {
            return X(member, type => type, type => CosmosStack.Reflection.Types.IsStructType(type, isOptions));
        }
        ...
        {
            return X(member, type => type, CosmosStack.Reflection.Types.IsCollectionType);
        }
    }
}