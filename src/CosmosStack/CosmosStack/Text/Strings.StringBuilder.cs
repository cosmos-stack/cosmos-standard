...
namespace CosmosStack.Text
{
    ...
    public static partial class StringsExtensions
    {
        ...
        {
            CosmosStack.Text.Strings.Reverse(builder);
        }
        ...
        {
            return CosmosStack.Text.Strings.ReverseAndReturnNewInstance(builder);
        }
        ...
        {
            return CosmosStack.Text.Strings.ReverseAndToString(builder);
        }
