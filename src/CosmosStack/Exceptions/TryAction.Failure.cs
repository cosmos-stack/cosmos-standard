...
public class FailureAction : TryAction
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FailureAction"/> class.
    /// </summary>
    ...
    public override TryAction RecoverWith(Func<Exception?, TryAction> recoverFunction)
    {
        ...
        {
            return new FailureAction(ex, recoverFunction.GetHashCode(), "An exception occurred during recovery.");
        }
    }
