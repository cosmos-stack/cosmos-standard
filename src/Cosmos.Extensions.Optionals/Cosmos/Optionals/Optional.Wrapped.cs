...
public static partial class Optional
{
    ...
    public static class Wrapped
    {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Some<T> NoneSlim<T>() => new(Cosmos.Optionals.Optional.None<T>());
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Some<T, TException> NoneSlim<T, TException>(TException exception) => new(Cosmos.Optionals.Optional.None<T, TException>(exception));
