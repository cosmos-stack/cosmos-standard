...
public struct UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IUnionType, IUnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
{
    readonly T0 _v0;
    readonly T1 _v1;
    readonly T2 _v2;
    ...
    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T0 t) => new(0, v0: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T1 t) => new(0, v1: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T2 t) => new(0, v2: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T3 t) => new(0, v3: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T4 t) => new(0, v4: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T5 t) => new(0, v5: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T6 t) => new(0, v6: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T7 t) => new(0, v7: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T8 t) => new(0, v8: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T9 t) => new(0, v9: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T10 t) => new(0, v10: t);

    public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(T11 t) => new(0, v11: t);
    ...
    internal static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromNull() => new(0);

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT0(T0 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT1(T1 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT2(T2 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT3(T3 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT4(T4 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT5(T5 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT6(T6 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT7(T7 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT8(T8 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT9(T9 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT10(T10 input) => input;

    public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> FromT11(T11 input) => input;

    public UnionType<TResult, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> MapT0<TResult>(Func<T0, TResult> mapFunc)
    {
        if (mapFunc is null)
    ...
    public UnionType<T0, TResult, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> MapT1<TResult>(Func<T1, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, TResult, T3, T4, T5, T6, T7, T8, T9, T10, T11> MapT2<TResult>(Func<T2, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, TResult, T4, T5, T6, T7, T8, T9, T10, T11> MapT3<TResult>(Func<T3, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, TResult, T5, T6, T7, T8, T9, T10, T11> MapT4<TResult>(Func<T4, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, TResult, T6, T7, T8, T9, T10, T11> MapT5<TResult>(Func<T5, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, TResult, T7, T8, T9, T10, T11> MapT6<TResult>(Func<T6, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, T6, TResult, T8, T9, T10, T11> MapT7<TResult>(Func<T7, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, T6, T7, TResult, T9, T10, T11> MapT8<TResult>(Func<T8, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, TResult, T10, T11> MapT9<TResult>(Func<T9, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult, T11> MapT10<TResult>(Func<T10, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> MapT11<TResult>(Func<T11, TResult> mapFunc)
    {
        if (mapFunc is null)
            throw new ArgumentNullException(nameof(mapFunc));
        return _ix switch
    ...
    public Maybe<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> AsOptionals()
    {
        return Optional.From(_v0, _v1, _v2, _v3, _v4, _v5, _v6, _v7, _v8, _v9, _v10, _v11);
    }

    bool Equals(UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> other)
    {
    ...
    public override bool Equals(object obj)
    {
        if (ReferenceEquals(null, obj))
            return false;
        return obj is UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> o && Equals(o);
    }
