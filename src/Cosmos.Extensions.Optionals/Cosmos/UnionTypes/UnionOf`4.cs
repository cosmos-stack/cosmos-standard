...
public class UnionOf<T0, T1, T2, T3, T4> : IUnionType, IUnionType<T0, T1, T2, T3, T4>
{
    readonly T0 _v0;
    readonly T1 _v1;
    readonly T2 _v2;
    ...
    protected UnionOf(UnionType<T0, T1, T2, T3, T4> input)
    {
        _ix = input.Index;
        switch (_ix)
        {
    ...
    bool Equals(UnionOf<T0, T1, T2, T3, T4> other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return obj is UnionOf<T0, T1, T2, T3, T4> o && Equals(o);
    }
