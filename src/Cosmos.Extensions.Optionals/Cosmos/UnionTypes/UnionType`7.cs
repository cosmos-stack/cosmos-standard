...
{
    public struct UnionType<T0, T1, T2, T3, T4, T5, T6, T7> : IUnionType, IUnionType<T0, T1, T2, T3, T4, T5, T6, T7>
    {
        readonly T0 _v0;
        readonly T1 _v1;
        readonly T2 _v2;
        ...
        UnionType(int ix, T0 v0 = default, T1 v1 = default, T2 v2 = default, T3 v3 = default, T4 v4 = default, T5 v5 = default, T6 v6 = default, T7 v7 = default)
        {
            _ix = ix;
            _v0 = v0;
            _v1 = v1;
        ...
        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T0 t) => new(0, v0: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T1 t) => new(0, v1: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T2 t) => new(0, v2: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T3 t) => new(0, v3: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T4 t) => new(0, v4: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T5 t) => new(0, v5: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T6 t) => new(0, v6: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4, T5, T6, T7>(T7 t) => new(0, v7: t);
        ...
        internal static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromNull() => new(0);

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT0(T0 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT1(T1 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT2(T2 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT3(T3 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT4(T4 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT5(T5 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT6(T6 input) => input;

        public static UnionType<T0, T1, T2, T3, T4, T5, T6, T7> FromT7(T7 input) => input;

        public UnionType<TResult, T1, T2, T3, T4, T5, T6, T7> MapT0<TResult>(Func<T0, TResult> mapFunc)
        {
            if (mapFunc is null)
        ...
        public UnionType<T0, TResult, T2, T3, T4, T5, T6, T7> MapT1<TResult>(Func<T1, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, TResult, T3, T4, T5, T6, T7> MapT2<TResult>(Func<T2, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, T2, TResult, T4, T5, T6, T7> MapT3<TResult>(Func<T3, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, T2, T3, TResult, T5, T6, T7> MapT4<TResult>(Func<T4, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, T2, T3, T4, TResult, T6, T7> MapT5<TResult>(Func<T5, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, T2, T3, T4, T5, TResult, T7> MapT6<TResult>(Func<T6, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public UnionType<T0, T1, T2, T3, T4, T5, T6, TResult> MapT7<TResult>(Func<T7, TResult> mapFunc)
        {
            if (mapFunc is null)
                throw new ArgumentNullException(nameof(mapFunc));
            return _ix switch
        ...
        public Maybe<T0, T1, T2, T3, T4, T5, T6, T7> AsOptionals()
        {
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj))
                return false;
            return obj is UnionType<T0, T1, T2, T3, T4, T5, T6, T7> o && Equals(o);
        }
