...
{
    public struct UnionType<T0, T1, T2, T3, T4> : IUnionType, IUnionType<T0, T1, T2, T3, T4>
    {
        readonly T0 _v0;
        readonly T1 _v1;
        readonly T2 _v2;
        ...
        UnionType(int ix, T0 v0 = default, T1 v1 = default, T2 v2 = default, T3 v3 = default, T4 v4 = default)
        {
            _ix = ix;
            _v0 = v0;
            _v1 = v1;
        ...
        public static implicit operator UnionType<T0, T1, T2, T3, T4>(T2 t) => new(0, v2: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4>(T3 t) => new(0, v3: t);

        public static implicit operator UnionType<T0, T1, T2, T3, T4>(T4 t) => new(0, v4: t);
        ...
        public static UnionType<T0, T1, T2, T3, T4> FromT0(T0 input) => input;

        public static UnionType<T0, T1, T2, T3, T4> FromT1(T1 input) => input;

        public static UnionType<T0, T1, T2, T3, T4> FromT2(T2 input) => input;

        public static UnionType<T0, T1, T2, T3, T4> FromT3(T3 input) => input;

        public static UnionType<T0, T1, T2, T3, T4> FromT4(T4 input) => input;
        ...
        public bool TryPickT0(out T0 value, out UnionType<T1, T2, T3, T4> remainder)
        {
        ...
        public bool TryPickT1(out T1 value, out UnionType<T0, T2, T3, T4> remainder)
        {
        ...
        public bool TryPickT2(out T2 value, out UnionType<T0, T1, T3, T4> remainder)
        {
        ...
        public bool TryPickT3(out T3 value, out UnionType<T0, T1, T2, T4> remainder)
        {
        ...
        public bool TryPickT4(out T4 value, out UnionType<T0, T1, T2, T3> remainder)
        {
        ...
        public Maybe<T0, T1, T2, T3, T4> ToMaybeValue()
        {
            return Optional.From(_v0, _v1, _v2, _v3, _v4);
        }

        bool Equals(UnionType<T0, T1, T2, T3, T4> other)
        {
        ...
        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj))
                return false;
            return obj is UnionType<T0, T1, T2, T3, T4> o && Equals(o);
        }
