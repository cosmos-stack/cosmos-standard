...
public class UnionOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> : IUnionType, IUnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>
{
    readonly T0 _v0;
    readonly T1 _v1;
    readonly T2 _v2;
    ...
    protected UnionOf(UnionType<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> input)
    {
        _ix = input.Index;
        switch (_ix)
        {
    ...
    /// <summary>
    /// Try to get the value of the fourteenth type <br />
    /// 尝试获取第 14 个类型的值
    /// </summary>
    /// <param name="value"></param>
    /// <param name="remainder"></param>
    ...
    /// <summary>
    /// Try to get the value of the fifteenth type <br />
    /// 尝试获取第 15 个类型的值
    /// </summary>
    /// <param name="value"></param>
    /// <param name="remainder"></param>
    ...
    /// <summary>
    /// Try to get the value of the sixteenth type <br />
    /// 尝试获取第 16 个类型的值
    /// </summary>
    /// <param name="value"></param>
    /// <param name="remainder"></param>
    ...
    bool Equals(UnionOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> other)
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        return obj is UnionOf<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> o && Equals(o);
    }
