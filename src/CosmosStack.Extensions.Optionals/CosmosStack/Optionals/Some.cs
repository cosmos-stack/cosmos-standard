...
namespace CosmosStack.Optionals
{
    ...
    public sealed class Some<T> : Optional<T, Some<T>>, IEquatable<Some<T>>, IComparable<Some<T>>
    {
        ...
        {
            return CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T>();
        }
        ...
        {
            return HasValue && !condition ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T>() : this;
        }
        ...
        public override Some<T> Filter(Func<T, bool> predicate)
        {
            ...
            return HasValue && !predicate(Value) ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T>() : this;
        }
        ...
        {
            return HasValue && Value is null ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T>() : this;
        }
