...
namespace CosmosStack.Optionals
{
                                              ...
                                              IComparable<Some<T, TException>>
    {
        ...
        {
            return HasValue && !condition ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exception) : this;
        }
        ...
        public override Some<T, TException> Filter(bool condition, Func<TException> exceptionFactory)
        {
            ...
            return HasValue && !condition ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exceptionFactory()) : this;
        }
        ...
        public override Some<T, TException> Filter(Func<T, bool> predicate, TException exception)
        {
            ...
            return HasValue && !predicate(Value) ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exception) : this;
        }
        ...
        public override Some<T, TException> Filter(Func<T, bool> predicate, Func<TException> exceptionFactory)
        {
            ...
            if (exceptionFactory is null)
                throw new ArgumentNullException(nameof(exceptionFactory));
            return HasValue && !predicate(Value) ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exceptionFactory()) : this;
        }
        ...
        {
            return HasValue && Value is null ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exception) : this;
        }
        ...
        public override Some<T, TException> NotNull(Func<TException> exceptionFactory)
        {
            if (exceptionFactory is null)
                throw new ArgumentNullException(nameof(exceptionFactory));
            return HasValue && Value is null ? CosmosStack.Optionals.Optional.Wrapped.NoneSlim<T, TException>(exceptionFactory()) : this;
        }
