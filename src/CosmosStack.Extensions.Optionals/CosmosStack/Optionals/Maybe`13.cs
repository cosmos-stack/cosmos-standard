...
namespace CosmosStack.Optionals
{
    ...
    [Serializable]
    public readonly struct Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> : IOptionalImpl<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>,
        ...
        IComparable<Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>
    {
        ...
        internal Maybe(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8, T9 value9, T10 value10, T11 value11, T12 value12, T13 value13, bool hasValue)
        {
            ...
            _hasValue = hasValue;
            _optionalIndexCache = NamedMaybeHelper.CreateIndexCache(13);
        }
        ...
        internal Maybe(T1 value1, string key1, T2 value2, string key2, T3 value3, string key3, T4 value4, string key4, T5 value5, string key5, T6 value6, string key6,
            ...
            T13 value13, string key13, bool hasValue)
        {
            _o1 = Optional.From(value1);
            _o2 = Optional.From(value2);
            _o3 = Optional.From(value3);
            ...
            _o13 = Optional.From(value13);
            _hasValue = hasValue;
            _optionalIndexCache = NamedMaybeHelper.CreateIndexCache(13, key1, key2, key3, key4, key5, key6, key7, key8, key9, key10, key11, key12, key13);
        }
            ...
            Maybe<T13> maybe13)
        {
            ...
            _optionalIndexCache = NamedMaybeHelper.CreateIndexCache(13, maybe1.Key, maybe2.Key, maybe3.Key, maybe4.Key, maybe5.Key, maybe6.Key, maybe7.Key, maybe8.Key, maybe9.Key, maybe10.Key, maybe11.Key, maybe12.Key,
                maybe13.Key);
        }
        ...
        /// <inheritdoc />
        public (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) Value => (Item1, Item2, Item3, Item4, Item5, Item6, Item7, Item8, Item9, Item10, Item11, Item12, Item13);
        ...
        /// <inheritdoc />
        public Type UnderlyingType => _o13.UnderlyingType;

        /// <summary>
        /// Gets all underlying type for this <see cref="Maybe{T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T13}"/>.
        /// </summary>
        public (Type, Type, Type, Type, Type, Type, Type, Type, Type, Type, Type, Type, Type) UnderlyingTypes =>
        ...
        public object this[int index]
        {
            get
            {
                return index switch
                {
                    ...
                    11 => _o12.Value,
                    12 => _o13.Value,
                    _ => throw new IndexOutOfRangeException($"Index value '{index}' must between [0, 13).")
                };
            }
        }
        ...
        /// <inheritdoc />
        public bool Equals((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) other)
        {
        ...
        /// <inheritdoc />
        public bool Equals(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => obj is Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> maybe && Equals(maybe);
        ...
        /// <inheritdoc />
        public int CompareTo((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) other)
        {
            if (!HasValue) return -1;
            var v = new[]
            {
                CompareHelper.Compare(Item1, other.Item1, 13),
                CompareHelper.Compare(Item2, other.Item2, 12),
                CompareHelper.Compare(Item3, other.Item3, 11),
                CompareHelper.Compare(Item4, other.Item4, 10),
                CompareHelper.Compare(Item5, other.Item5, 9),
                CompareHelper.Compare(Item6, other.Item6, 8),
                CompareHelper.Compare(Item7, other.Item7, 7),
                CompareHelper.Compare(Item8, other.Item8, 6),
                CompareHelper.Compare(Item9, other.Item9, 5),
                CompareHelper.Compare(Item10, other.Item10, 4),
                CompareHelper.Compare(Item11, other.Item11, 3),
                CompareHelper.Compare(Item12, other.Item12, 2),
                CompareHelper.Compare(Item13, other.Item13, 1)
            };
            return CompareHelper.Calc(v);
        }

        /// <inheritdoc />
        public int CompareTo(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> other)
        {
        ...
        /// <returns></returns>
        public static bool operator ==(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> left, Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> right) => left.Equals(right);
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        public static bool operator <(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> left, Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> right) => left.CompareTo(right) < 0;
        ...
        /// <returns></returns>
        public static implicit operator (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> maybe)
        {
            return maybe.Value;
        }
        ...
        /// <returns></returns>
        public static explicit operator Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) tuple)
        {
        ...
        {
            return HasValue
                ? $"Some(Item1:{Item1},Item2:{Item2},Item3:{Item3},Item4:{Item4},Item5:{Item5},Item6:{Item6},Item7:{Item7},Item8:{Item8},Item9:{Item9},Item10:{Item10},Item11:{Item11},Item12:{Item12},Item13:{Item13})"
                : "None";
        }
        ...
        /// <inheritdoc />
        public bool Contains((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) value)
        {
        ...
        /// <inheritdoc />
        public bool Exists(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), bool> predicate)
        {
        ...
        /// <inheritdoc />
        public (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) ValueOr((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) alternative)
        {
            return HasValue ? Value : alternative;
        }

        /// <inheritdoc />
        public (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) ValueOr(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> alternativeFactory)
        {
        ...
        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Or((T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13) alternative)
        {
            return HasValue ? this : Optional.From(alternative);
        }

        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Or(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> alternativeFactory)
        {
            if (alternativeFactory is null)
                throw new ArgumentNullException(nameof(alternativeFactory));
        ...
        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Else(Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> alternativeMaybe)
        {
            return HasValue ? this : alternativeMaybe;
        }

        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Else(Func<Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> alternativeMaybeFactory)
        {
        ...
        /// <inheritdoc />
        public Either<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException> WithException<TException>(TException exception)
        {
            return Match(
                someFactory: Optional.Some<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException>,
                noneFactory: () => Optional.None<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException>(exception));
        }

        /// <inheritdoc />
        public Either<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException> WithException<TException>(Func<TException> exceptionFactory)
        {
            if (exceptionFactory is null)
                throw new ArgumentNullException(nameof(exceptionFactory));
            return Match(
                someFactory: Optional.Some<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException>,
                noneFactory: () => Optional.None<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TException>(exceptionFactory()));
        }
        ...
        /// <inheritdoc />
        public TResult Match<TResult>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TResult> someFactory, Func<TResult> noneFactory)
        {
        ...
        /// <inheritdoc />
        public void Match(Action<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> someAct, Action noneAct)
        {
            if (someAct is null)
        ...
        /// <inheritdoc />
        public void MatchMaybe(Action<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> maybeAct)
        {
            if (maybeAct is null)
        ...
        /// <inheritdoc />
        public Maybe<TResult> Map<TResult>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), TResult> mapping)
        {
            if (mapping is null)
        ...
        /// <inheritdoc />
        public Maybe<TResult> FlatMap<TResult>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), Maybe<TResult>> mapping)
        {
            if (mapping is null)
                throw new ArgumentNullException(nameof(mapping));
            return Match(
        ...
        /// <inheritdoc />
        public Maybe<TResult> FlatMap<TResult, TException>(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), Either<TResult, TException>> mapping)
        {
            if (mapping is null)
                throw new ArgumentNullException(nameof(mapping));
        ...
        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Filter(bool condition)
        {
            return HasValue && !condition ? Nothing : this;
        }

        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Filter(Func<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13), bool> predicate)
        {
            if (predicate is null)
                throw new ArgumentNullException(nameof(predicate));
        ...
        /// <inheritdoc />
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> NotNull()
        {
            return HasValue &&
                   _o1.Value is null &&
                   _o2.Value is null &&
        ...
        /// </summary>
        /// <returns></returns>
        public Some<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13)> ToWrappedSome() => new(Value);
        ...
        /// <returns></returns>
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Join<T14>(T14 valueToJoin)
            => new(_o1, _o2, _o3, _o4, _o5, _o6, _o7, _o8, _o9, _o10, _o11, _o12, _o13, Optional.From(valueToJoin));
        ...
        /// <typeparam name="T14"></typeparam>
        /// <returns></returns>
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Join<T14>(T14 valueToJoin, Func<T14, bool> condition)
            => new(_o1, _o2, _o3, _o4, _o5, _o6, _o7, _o8, _o9, _o10, _o11, _o12, _o13, Optional.From(valueToJoin, condition));
        ...
        /// <typeparam name="T14"></typeparam>
        /// <returns></returns>
        public Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> Join<T14>(Maybe<T14> optionalToJoin)
            => new(_o1, _o2, _o3, _o4, _o5, _o6, _o7, _o8, _o9, _o10, _o11, _o12, _o13, optionalToJoin);
        ...
        /// </summary>
        public static Maybe<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Nothing => Optional.None<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>();
