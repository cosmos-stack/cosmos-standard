...
namespace CosmosStack.Optionals
{
    ...
    public static class OptionalsExtensions
    {
        ...
        public static Maybe<T> AsOptionals<T>(this T value) => CosmosStack.Optionals.Optional.Some(value);
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Either<T, TException> AsOptionals<T, TException>(this T value) => CosmosStack.Optionals.Optional.Some<T, TException>(value);
            ...
            OptionalType type = OptionalType.ReferenceType)
        {
            return type == OptionalType.ReferenceType
                ? CosmosStack.Optionals.Optional.Wrapped.Some(value)
                : CosmosStack.Optionals.Optional.Some(value) as IOptional<T>;
        }
        ...
        {
            return type == OptionalType.ReferenceType
                ? CosmosStack.Optionals.Optional.Wrapped.Some<T, TException>(value)
                : CosmosStack.Optionals.Optional.Some<T, TException>(value) as IOptional<T, TException>;
        }
        ...
        {
            return type == OptionalType.ReferenceType
                ? CosmosStack.Optionals.Optional.Wrapped.None<T>()
                : CosmosStack.Optionals.Optional.None<T>() as IOptional<T>;
        }
        ...
        {
            return type == OptionalType.ReferenceType
                ? CosmosStack.Optionals.Optional.Wrapped.None<T, TException>(exception)
                : CosmosStack.Optionals.Optional.None<T, TException>(exception) as IOptional<T, TException>;
        }
            ...
            OptionalType type = OptionalType.ReferenceType) where T : struct
        {
            return value.HasValue
                ? type == OptionalType.ReferenceType
                    ? CosmosStack.Optionals.Optional.Wrapped.Some(value.Value)
                    : CosmosStack.Optionals.Optional.Some(value.Value) as IOptional<T>
                : type == OptionalType.ReferenceType
                    ? CosmosStack.Optionals.Optional.Wrapped.None<T>()
                    : CosmosStack.Optionals.Optional.None<T>() as IOptional<T>;
        }
            ...
            OptionalType type = OptionalType.ReferenceType) where T : struct
        {
            return value.HasValue
                ? type == OptionalType.ReferenceType
                    ? CosmosStack.Optionals.Optional.Wrapped.Some<T, TException>(value.Value)
                    : CosmosStack.Optionals.Optional.Some<T, TException>(value.Value) as IOptional<T, TException>
                : type == OptionalType.ReferenceType
                    ? CosmosStack.Optionals.Optional.Wrapped.None<T, TException>(exception)
                    : CosmosStack.Optionals.Optional.None<T, TException>(exception) as IOptional<T, TException>;
        }
            ...
            OptionalType type = OptionalType.ReferenceType) where T : struct
        {
            ...
            return value.HasValue
                ? type == OptionalType.ReferenceType
                    ...
                    : CosmosStack.Optionals.Optional.Some<T, TException>(value.Value) as IOptional<T, TException>
                : type == OptionalType.ReferenceType
                    ? CosmosStack.Optionals.Optional.Wrapped.None<T, TException>(exceptionFactory())
                    : CosmosStack.Optionals.Optional.None<T, TException>(exceptionFactory()) as IOptional<T, TException>;
        }
        ...
        public static Maybe<string> NoneIfEmpty(this string str) =>
            string.IsNullOrEmpty(str)
                ? CosmosStack.Optionals.Optional.None<string>()
                : CosmosStack.Optionals.Optional.Some(str);
        ...
        public static Maybe<TEnum> TryParse<TEnum>(this string value, bool ignoreCase = false) where TEnum : struct =>
            Enum.TryParse(value, ignoreCase, out TEnum outValue) ? CosmosStack.Optionals.Optional.Some(outValue) : CosmosStack.Optionals.Optional.None<TEnum>();
        ...
        public static Maybe<T> FirstOrNone<T>(this IEnumerable<T> source)
        {
            ...
            return CosmosStack.Optionals.Optional.None<T>();
        }
        ...
        public static Maybe<T> SingleOrNone<T>(this IEnumerable<T> source)
        {
            ...
            if (source is IList<T> list)
            {
                switch (list.Count)
                {
                    case 0: return CosmosStack.Optionals.Optional.None<T>();
        ...
        public static Task<Maybe<TResult>> MapAsync<T, TResult>(this Maybe<T> option, Func<T, Task<TResult>> mapping)
        {
            ...
            return option.Map(mapping).Match(
                ...
                noneFactory: () => Task.FromResult(CosmosStack.Optionals.Optional.None<TResult>())
            );
        }
        ...
        public static Task<Either<TResult, TException>> MapAsync<T, TException, TResult>(this Either<T, TException> option, Func<T, Task<TResult>> mapping)
        {
            ...
            return option.Map(mapping).Match(
                ...
                noneFactory: exception => Task.FromResult(CosmosStack.Optionals.Optional.None<TResult, TException>(exception))
            );
        }
            ...
            Func<TException, Task<TExceptionResult>> mapping)
        {
            return option.MapException(mapping).Match(
                someFactory: value => Task.FromResult(CosmosStack.Optionals.Optional.Some<T, TExceptionResult>(value)),
                noneFactory: async exceptionTask =>
                {
                    ...
                    return CosmosStack.Optionals.Optional.None<T, TExceptionResult>(exception);
                }
            );
        }
