...
public static partial class DateTimeExtensions
{
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsSameDay(this DateTime dt, DateTime date, DateDiffStrictOptions options = DateDiffStrictOptions.Default)
    {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsSameMonth(this DateTime dt, DateTime date, DateDiffStrictOptions options = DateDiffStrictOptions.Default)
    {
        return options switch
        {
