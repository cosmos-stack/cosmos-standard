...
public static partial class Types
{
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsValueType<T>(TypeIsOptions isOptions = TypeIsOptions.Default)
    {
        return IsValueType(typeof(T), isOptions);
    }
    ...
    {
        return value is not null && IsValueType(typeof(T), isOptions);
    }
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsPrimitiveType<T>(TypeIsOptions isOptions = TypeIsOptions.Default)
    {
        return IsPrimitiveType(typeof(T), isOptions);
    }
    ...
    {
        return value is not null && IsPrimitiveType(typeof(T), isOptions);
    }
