...
public static class TaskFire
{
    ...
    public static void SafeFireAndForget(Task task, Action<Exception> exceptionAction = null, bool continueOnCapturedContext = false)
    {
    ...
    public static void SafeFireAndForget<TException>(Task task, Action<TException> exceptionAction = null, bool continueOnCapturedContext = false)
    ...
    {
        _globalExceptionAction = exceptionAction ?? throw new ArgumentNullException(nameof(exceptionAction));
    }
...
public static class TaskFireExtensions
{
    ...
    /// <param name="exceptionAction"></param>
    /// <param name="continueOnCapturedContext"></param>
    public static void SafeFireAndForget(this Task task, Action<Exception> exceptionAction = null, bool continueOnCapturedContext = false)
    {
    ...
    /// <param name="continueOnCapturedContext"></param>
    /// <typeparam name="TException"></typeparam>
    public static void SafeFireAndForget<TException>(this Task task, Action<TException> exceptionAction = null, bool continueOnCapturedContext = false)
        where TException : Exception
    {
        TaskFire.SafeFireAndForget(task, exceptionAction, continueOnCapturedContext);
    }
