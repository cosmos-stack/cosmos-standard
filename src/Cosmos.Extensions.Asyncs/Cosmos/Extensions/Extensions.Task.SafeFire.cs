...
namespace Cosmos.Asynchronous
{
    ...
    public static partial class TaskExtensions
    {
        ...
        private static async void HandleSafeFireAndForget<TException>(Task task, bool continueOnCapturedContext, Action<TException> exceptionAction)
            where TException : Exception
        {
            try
            {
        ...
        private static void HandleException<TException>(TException exception, Action<TException> exceptionAction)
            where TException : Exception
        {
